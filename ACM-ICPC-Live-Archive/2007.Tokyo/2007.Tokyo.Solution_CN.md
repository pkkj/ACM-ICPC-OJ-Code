...
OJ and Id					| Language	| Run Time / Limit    	    |
 -----------------------	| --------  | -------------   		    |
POJ 3520                    | C++		| 1719 ms / 5000 ms 		|
POJ 3520                    | G++		| Wrong Answer	 		    |
ACM-ICPC Live Archive 3885	| C++		| 0.869 s / 3.000 s    	    |
...
OJ and Id					| Language	| Run Time / Limit    	    |
 -----------------------	| --------  | -------------   		    |
POJ 3521                    | C++		| 79 ms / 5000 ms   		|
ACM-ICPC Live Archive 3886	| C++		| 0.043 s / 3.000 s    	    |
...
OJ and Id					| Language	| Run Time / Limit     	    |
 -----------------------	| --------  | -------------   		    |
POJ 3523                    | G++		| 5875 ms / 8000 ms 		|
POJ 3523                    | C++		| 7797 ms / 8000 ms 		|
ACM-ICPC Live Archive 3888	| C++		| 3.806 s / 12.000 s  	    |
...
OJ and Id					| Language	| Run Time / Limit    	    |
 -----------------------	| --------  | -------------   		    |
POJ 3525                    | C++		| 16 ms / 5000 ms		    |
ACM-ICPC Live Archive 3890	| C++		| 0.006 s / 3.000 s 	    |
